...
public class TestOrderNew extends TestBase {
	static final String FILENAME = "./ConfigFile/orderNumber.txt";
	CatalogPage objCatalog = new CatalogPage();

	public void testOrderNew(String serviceName, String offerName, String offerCode, String quantity, String paymentMethod,
			String budgetCode, String existingMicrosoftCloudCustomer, String microsoftPrimaryDomain) throws Exception
	  {
