...
public class PoliciesPage extends TestBase {
	...
	public WebElement regionsCheckBox(String region) {
		...
		return getDriver().findElement(By.xpath(requiredXpath.replace("needsSubstitution", region))); 
	}
	...
	public WebElement imagesCheckBox(String image) {
		...
		return getDriver().findElement(By.xpath(requiredXpath.replace("needsSubstitution", image))); 
	}
	...
	public WebElement sizesCheckBox(String size) {
		String requiredXpath = "//input[@value='needsSubstitution']";
		return getDriver().findElement(By.xpath(requiredXpath.replace("needsSubstitution", size))); 
	}
	...
	public WebElement networksCheckBox(String network) {
		String requiredXpath = "//label[span[contains(text(),'needsSubstitution')]]/input";
		return getDriver().findElement(By.xpath(requiredXpath.replace("needsSubstitution", network))); 
	}
	...
	public WebElement policyNameText(String policyName) {
		...
		return getDriver().findElement(By.xpath(requiredXpath.replace("needsSubstitution", policyName)));
	}
	...
	public WebElement resourceTagKeyTextBox(int a) {
		...
		return getDriver().findElement(By.xpath(requiredXpath.replace("needsSubstitution", Integer.toString(a))));	
	}
